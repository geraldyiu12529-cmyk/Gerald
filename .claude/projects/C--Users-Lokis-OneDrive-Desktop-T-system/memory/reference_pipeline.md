...
type: reference
originSessionId: 6c5f9e8c-c9c7-48a8-8a24-ff231d08be3f
---
...
## Migration to Claude Code routines — 2026-04-19

All 8 daily tasks + 2 weekly + 6 infrequent ported to Claude Code cloud routines.
Repo: https://github.com/geraldyiu12529-cmyk/Gerald (private, main branch)
Workspace content in Trade/ subdirectory; all routine prompts include `cd Trade/` preamble.
Cowork scheduled tasks remain ENABLED during 3-day parallel-run window (cutover pending).
Phase 3 SKILL.md patches (V029–V035 meta-integration) gated on 2026-04-25 shadow review.
Python smoke test deferred — Python not in git-bash PATH on Windows; install before Phase 4 live-fire.
