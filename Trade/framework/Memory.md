...
**Last updated:** 2026-04-21 11:30 UTC+8 (trade-rec v3 for 2026-04-20: SPY Long promoted half-size 1.0%; QQQ near-miss correlation-blocked; 6 assets at Sum +2; 11 single-stock T-blocked by residual-mom numpy failure. Prior sync 2026-04-20 17:07 — 3 new off-methodology entries AAVEUSDT P006, TSLAUSDT P007, CLUSDT P008.)
**Maintainer:** Gerald
...
| **SPY** | **Long** | **PROMOTED 2026-04-20 v3 — half-size 1.0%, entry $710.14, stop $696 (2× ATR), target $720/$730, time-stop 2026-05-13** | VIX >25; SPY break below $696; HY OAS >4.50%; FOMC hawkish surprise Apr-28 → exit into print if SPY <$700 | **Sum +3 (S+1/T+1/C0/R+1).** Half-size sizing acknowledges 4 risk haircuts: IC z MISSING (R conditional on proxies), FOMC Apr-28 hawkish tail, C=0 no near-term tailwind, ceasefire Apr-22 cross-asset spillover risk. SignalLedger P009 pending fill. Logged trade-rec-2026-04-20.md v3. |
