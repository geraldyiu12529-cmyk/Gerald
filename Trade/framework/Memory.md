...
**Last updated:** 2026-04-22 20:35 UTC+8 (trade-rec v1: P016 Brent Long promoted — first commodity post-sleeve-confirmation; P017 BTC Sum+3 gate-blocked; near-misses N042–N046. Earlier today 11:05 UTC+8: P009 SPY T5 and P010 EWJ T3 dip-buy adds, Asian session.)
**Maintainer:** Gerald
...
| **Brent** | **Long** | **PROMOTED P016 — entry $94.00–94.50 limit/at-market (currently $94.19)** | Iran deal confirmed → Brent <$88; Hormuz re-opens shipping >70% normal within 10 days; time-stop 2026-05-22 | **Sum +3 (S+1/T+1/C0/R+1). Primary commodity promotion post-sleeve-confirmation (V034 GSG 31.75 >> 10m-SMA 25.35, CONFIRMED ON first time this cycle). T flipped +1 on confirmed uptrend $90→$94.19 (+4.6%). S+1 basis-mom fresh T1 Apr-22 (backwd+13.95, steepening aligned). Size 0.75% (corr+binary haircut + TSLA earnings tonight cross-asset risk + FOMC Apr-28 tail). Stop $90.50 (2× ATR ~$3.7). Target $98/$102. ATR stop; PARTIAL checklist #6 (C=0, structural edge only — same SPY P009 precedent). Logged P016. Local trade-rec-2026-04-22 v1.** |
