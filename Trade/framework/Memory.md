...
**Last updated:** 2026-04-21 20:20 UTC+8 (trade-rec v2 local: P013 INTC PROMOTED pending Apr-23 beat; P014 AAPL PROMOTED active entry; P015 GOOGL PROMOTED pending Apr-23 beat. P008 still open. P009/P010 fill pending.)
**Maintainer:** Gerald
...
| **SPY** | **Long** | **PROMOTED 2026-04-20 v3 (re-confirmed 2026-04-21 v2 local) — half-size 1.0%, entry $710.14, stop $696 (2× ATR), target $720/$730, time-stop 2026-05-13** | VIX >25; SPY break below $696; HY OAS >4.50%; FOMC hawkish surprise Apr-28 → exit into print if SPY <$700 | **Sum +3 (S+1/T+1/C0/R+1).** V027 z +1.65 (A, fresh at local run) — R now Grade A confirmed, not proxy. Half-size maintained for FOMC Apr-28 tail and C=0. SignalLedger P009 pending fill. Re-confirmed trade-rec-2026-04-21.md v2 local. |
| **EWJ** | **Long** | **PROMOTED 2026-04-21 v2 local (P010) — 0.75% risk, entry ~$90.24, stop $86.00 (2× ATR ~$4.4), target $95/$98, time-stop 2026-06-30** | USDJPY <150 (JPY over-appreciation → exporter damage); Nikkei −5% from current; BOJ emergency hike ≥50bp; US-China trade war escalation | **Sum +3 (S+1/T+1/C0/R+1).** Raw TSMOM applies (ETF). Nikkei +1.21% Apr-21, Kospi record high. V027 z +1.65 (A, fresh) = R now Grade A confirmed. BOJ unchanged 0.75%; USDJPY 158.90; FM threshold 160. Logged trade-rec-2026-04-21.md v2 local. |
