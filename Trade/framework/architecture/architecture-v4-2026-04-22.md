# T.system Architecture — v4
**Version:** 4  
**Dated:** 2026-04-22  
**Prior version:** `architecture-v3-2026-04-21.md`  
**Supersedes:** v3 (for consumer reads)

**Changes from v3:**
- **§2 Key Documents:** Removed rows for `Trade/.claude/rules/evidence-grades.md`, `Trade/.claude/rules/risk-rules-summary.md`, and `Trade/.claude/CLAUDE.md` — all deleted in 2026-04-22 cleanup. Rules content is now embedded in `~/.claude/CLAUDE.md`.
- **§4 Skills:** Updated skills path header from `Trade/.claude/skills/{skill-name}/SKILL.md` to `~/.claude/skills/{skill-name}/SKILL.md`
- **§5 Skill tables:** All `Trade/.claude/skills/*/SKILL.md` → `~/.claude/skills/*/SKILL.md`
- **§6 Mermaid diagram:** Skill node labels updated `Trade/.claude/skills/` → `~/.claude/skills/`
- **§8 Workspace canonicalization:** Updated to reflect 2026-04-22 state — `Trade/.claude/` deleted, skills consolidated to `~/.claude/skills/`, `cowork/` deleted
- **Governance rule §4:** Updated skill wiring source-of-truth path to `~/.claude/skills/{skill}/SKILL.md`
