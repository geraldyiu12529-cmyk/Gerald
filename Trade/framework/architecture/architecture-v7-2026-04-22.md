...
| 2026-04-22 | HTML report THESIS dict and DISCUSSION list upgraded to full analytical paragraphs; writing standards added to Methodology Prompt.md §8.1, Memory.md HTML generator note, daily-trade-rec SKILL.md Step 10; `thesis_html()` updated to render `<p>` tags with 1.7 line-height | Thesis/discussion were terse one-liners; now each thesis is 4–8 sentences covering score mechanism, edge, invalidation, and next action; each discussion item is 5–10 sentences covering why, how, scenarios, and portfolio impact |
