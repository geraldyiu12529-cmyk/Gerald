# T.system Architecture — v5
**Version:** 5  
**Dated:** 2026-04-22  
**Prior version:** `architecture-v4-2026-04-22.md`  
**Supersedes:** v4 (for consumer reads)

**Changes from v4:**
- **§2 Key Documents:** Master Data Log updated from 10 → 11 sheets (HypoLedger added 2026-04-22).
- **§5 daily-trade-rec:** Added `→ appends | HypoLedger` row (Step 8.5 — formally promoted signals at rec price for system efficacy tracking).
- **§5 signal-review:** Added `← reads | HypoLedger` row and split the Excel update row to explicitly list `HypoLedger (mark-to-market + dim-14 efficacy)` alongside PerformanceStats.
- **§6 Mermaid:** Excel node label updated to include HypoLedger.
- **§9 Changelog:** HypoLedger addition logged.
...
graph TD
    ...
    MS["methodology-sync · Sonnet\n~/.claude/skills/methodology-sync/"]
