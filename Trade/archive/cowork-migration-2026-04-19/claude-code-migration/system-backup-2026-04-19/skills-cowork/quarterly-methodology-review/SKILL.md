...
Produce a single-file HTML report at `/mnt/Trade/report-{YYYY-MM-DD}-quarterly-review.html`. Use Chart.js via CDN (`https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.0/c