...
- `/mnt/Trade/memory-lessons.md` (Lessons): append one line: date, brief version, regime label, count of MISSING rows, any material delta vs prior brief. (Memory.md §8 is a pointer to this file.)
