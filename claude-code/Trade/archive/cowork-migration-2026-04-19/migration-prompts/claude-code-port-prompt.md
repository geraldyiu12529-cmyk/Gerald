...
5. **Enumerate scheduled tasks** that must become Claude Code routines. Authoritative list from `auto-memory/reference_pipeline.md` plus 2026-04-18 meta-integration additions:
   ...
   **Count: 16 routines total** (8 daily + 2 weekly + 6 infrequent). Note: Pro plan caps at 5/day, Max at 15/day, Team/Enterprise at 25/day. Gerald needs at least Max to run all 8 daily routines in the cloud; otherwise some must stay as Desktop scheduled tasks.
